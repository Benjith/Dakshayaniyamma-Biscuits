...
--
-- Host: 127.0.0.1
-- Generation Time: May 23, 2018 at 11:34 AM
...
--
-- Table structure for table `advancesalary_tbl`
--

CREATE TABLE `advancesalary_tbl` (
  `advanceSalaryId` int(11) NOT NULL,
  `employeeId` int(11) DEFAULT NULL,
  `advanceFor` text COLLATE utf8_bin,
  `advanceDate` datetime DEFAULT NULL,
  `Amount` decimal(18,2) DEFAULT NULL,
  `PaidAmount` decimal(18,2) DEFAULT NULL,
  `detailedSummary` text COLLATE utf8_bin,
  `description` text COLLATE utf8_bin,
  `status` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `statusModifiedBy` int(11) DEFAULT NULL,
  `entryDate` datetime DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `employee_tbl` (
  ...
  `employeeCode` text COLLATE utf8_bin,
  `employeeName` text COLLATE utf8_bin,
  `designationId` int(11) DEFAULT NULL,
  `doj` date DEFAULT NULL,
  `employeeType` text COLLATE utf8_bin,
  `companyEmail` text COLLATE utf8_bin,
  `companyPhone` text COLLATE utf8_bin,
  `status` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `photoImg` longblob,
  `genter` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `dob` date DEFAULT NULL,
  `maritalStatus` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  ...
  `eduQualification` text COLLATE utf8_bin,
  `salaryType` text COLLATE utf8_bin,
...
CREATE TABLE `privilege_tbl` (
  ...
  `formName` varchar(150) COLLATE utf8_bin DEFAULT NULL,
  `action` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `entryDate` datetime DEFAULT CURRENT_TIMESTAMP,
  `menuHead` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `menuName` varchar(100) COLLATE utf8_bin DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
--
-- Indexes for table `advancesalary_tbl`
--
ALTER TABLE `advancesalary_tbl`
  ADD PRIMARY KEY (`advanceSalaryId`),
  ADD KEY `FK__advanceSa__emplo__3F3159AB` (`employeeId`),
  ADD KEY `FK__advanceSa__finan__3627DDB5` (`financialYearId`),
  ADD KEY `FK__advanceSa__statu__40257DE4` (`statusModifiedBy`);
...
ALTER TABLE `employee_tbl`
  ...
  ADD KEY `FK__employee___desig__39788055` (`designationId`),
  ADD KEY `FK__employee___ledge__6F9F86DC` (`ledgerId`);
...
ALTER TABLE `privilege_tbl`
  ...
  ADD KEY `FK__privilege__roleI__5D95E53A` (`roleId`);
...
--
-- AUTO_INCREMENT for table `advancesalary_tbl`
--
ALTER TABLE `advancesalary_tbl`
  MODIFY `advanceSalaryId` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `advancesalary_tbl`
--
ALTER TABLE `advancesalary_tbl`
  ADD CONSTRAINT `FK__advanceSa__emplo__3F3159AB` FOREIGN KEY (`employeeId`) REFERENCES `employee_tbl` (`employeeId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK__advanceSa__finan__3627DDB5` FOREIGN KEY (`financialYearId`) REFERENCES `financialyear_tbl` (`financialYearId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK__advanceSa__statu__40257DE4` FOREIGN KEY (`statusModifiedBy`) REFERENCES `employee_tbl` (`employeeId`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `employee_tbl`
  ADD CONSTRAINT `FK__employee___desig__39788055` FOREIGN KEY (`designationId`) REFERENCES `designation_tbl` (`designationId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK__employee___ledge__6F9F86DC` FOREIGN KEY (`ledgerId`) REFERENCES `ledger_tbl` (`ledgerId`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `privilege_tbl`
  ADD CONSTRAINT `FK__privilege__roleI__5D95E53A` FOREIGN KEY (`roleId`) REFERENCES `role_tbl` (`roleId`) ON DELETE NO ACTION ON UPDATE NO ACTION;
